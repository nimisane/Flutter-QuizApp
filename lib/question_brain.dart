...
class QuestionsBank {
  ...
  List<Questions> _questionsBrain = [
  ...
  void nextQuestion() {
    if (questionNumber < _questionsBrain.length-1) {
      questionNumber++;}
  }
  ...
  String getQuestions() {
    return _questionsBrain[questionNumber].questions;
  }

  bool getAnswers() {
    return _questionsBrain[questionNumber].answers;
  }
